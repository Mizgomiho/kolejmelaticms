...
$query=mysqli_query($con,"insert into tblcomplaints(userId,category,subcategory,complaintType,block,noc,complaintDetails,complaintFile) values('$uid','$category','$subcat','$complaintype','$block','$noc','$complaintdetials','$compfile')");
...
<html lang="en">
  <head>
    ...
    <title>Kolej Melati | User Register Complaint</title>
